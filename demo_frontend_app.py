...
# Page configuration
st.set_page_config(page_title="AI Career Mentor (Demo)", page_icon="🤖", layout="wide")

# Demo notice
st.info(
    "🎭 **Demo Mode**: This is a demonstration using simulated AI responses. The full version integrates with Azure OpenAI for real AI-powered career advice!"
)
