...
class TestSettings:
    ...
    def test_settings_from_environment_variables(self):
        ...
        with patch.dict(os.environ, env_vars):
            ...
            assert settings.azure_openai_endpoint == 'https://env-test.openai.azure.com/'
    ...
    def test_temperature_validation(self):
        ...
        for invalid_temp in ['-0.1', '2.1', '5.0', 'invalid']:
            with patch.dict(os.environ, {**base_env, 'DEFAULT_TEMPERATURE': invalid_temp}):
    ...
    def test_max_tokens_validation(self):
        ...
        for invalid_tokens in ['0', '-100', 'invalid']:
            with patch.dict(os.environ, {**base_env, 'DEFAULT_MAX_TOKENS': invalid_tokens}):
                with pytest.raises(ValidationError):
                    Settings()
    ...
    def test_endpoint_url_validation(self):
        ...
        for invalid_url in invalid_urls:
            with patch.dict(os.environ, {**base_env, 'AZURE_OPENAI_ENDPOINT': invalid_url}):
                with pytest.raises(ValidationError):
                    Settings()
    ...
    def test_cosmos_db_configuration(self):
        ...
        with patch.dict(os.environ, cosmos_env):
            settings = Settings()
            assert settings.cosmos_db_endpoint == 'https://test-cosmos.documents.azure.com:443/'
