...
class MonitoringAlertsService:
    ...
    async def _check_alert_rules(self):
        ...
        try:
            ...
            current_metrics = self._calculate_derived_metrics(health_metrics, metrics_export)
    ...
    def _calculate_derived_metrics(self, health_metrics: Dict[str, Any], metrics_export: Dict[str, Any]) -> Dict[str, float]:
        ...
        try:
            ...
            if threshold_breached:
                if existing_alert is None:
                    ...
                    if time_since_detection.total_seconds() >= rule.duration_minutes * 60:
                        if existing_alert.status == AlertStatus.ACTIVE and not hasattr(existing_alert, '_notified'):
            ...
            logger.error("Failed to evaluate alert rule", rule_name=rule.name, error=str(e))
